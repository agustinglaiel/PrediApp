...
import (
	...
	repository "admin/internal/repository/users"
	e "admin/pkg/utils"
	"context"
	"time"
...
type UserServiceInterface interface {
    ...
    GetUsers(ctx context.Context, limit, offset int) ([]dto.UserResponseDTO, e.ApiError)
...
func (s *userService) GetUsers(ctx context.Context, limit, offset int) ([]dto.UserResponseDTO, e.ApiError) {
    users, apiErr := s.userRepo.GetUsers(ctx, limit, offset)
    if apiErr != nil {
        return nil, apiErr
    }
...
func (s *userService) UpdateUserRole(ctx context.Context, id uint, newRole string) e.ApiError {
    user, apiErr := s.userRepo.GetUserByID(ctx, id)
    if apiErr != nil {
        return apiErr
    }
...
func (s *userService) DeactivateUserById(ctx context.Context, id uint) e.ApiError {
    user, apiErr := s.userRepo.GetUserByID(ctx, id)
    if apiErr != nil {
        return apiErr
    }
...
func (s *userService) ReactivateUserById(ctx context.Context, id uint) e.ApiError {
    user, apiErr := s.userRepo.GetUserByID(ctx, id)
    if apiErr != nil {
        return apiErr
    }
